...
namespace SeoPack.Helpers
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString SpTitle(this HtmlHelper htmlHelper, string title)
        {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpMetaDescription(this HtmlHelper htmlHelper, string description)
        {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpImage(this HtmlHelper htmlHelper, Image image)
        {
            if (image == null)
            {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpAnchor(this HtmlHelper htmlHelper, Anchor anchor)
        {
            if (anchor == null)
            {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpImageLink(this HtmlHelper htmlHelper, ImageLink imageLink)
        {
            if (imageLink == null)
            {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpCanonicalLinkIfRequired(this HtmlHelper htmlHelper, string canonicalUrl)
        {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpOpenGraph(this HtmlHelper htmlHelper, Og og)
        {
            if (og == null)
            {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpPaginationLink(this HtmlHelper htmlHelper, PaginationLink paginationLink)
        {
        ...
        /// <returns>The html string.</returns>
        public static IHtmlString SpHrefLangLink(this HtmlHelper htmlHelper, IEnumerable<HrefLangPage> hrefLangPages)
        {
        ...
        private static HtmlElement BuildAnchorTag(AnchorBase anchor, string anchorText = "")
        {
        ...
        private static HtmlElement BuildImageTag(Image image)
        {
        ...
        private static IDictionary<string, string> AnonymousObjectToHtmlAttributes(object o)
        {
